...
cdf_file = 'assets\COPERNICUS_DWNLDS\TSM_COP_DIC_2023_PERU_M.nc'
cdf_data = cdf.Dataset(cdf_file)

so = np.array(cdf_data['thetao'])
...
plot_tsm = ax.contourf(lon, lat, data, levels = np.linspace(13, 31, 19), cmap = 'rainbow')
